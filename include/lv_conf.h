...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #ifndef LV_MEM_SIZE
                #define LV_MEM_SIZE (16U * 1024U)          /**< [bytes] - Header default: 16 KB. PlatformIO build flags may override this value (this project sets `-D LV_MEM_SIZE=24576` in platformio.ini to use 24KB). */
    #endif
...
#define LV_DRAW_LAYER_SIMPLE_BUF_SIZE    (8 * 1024)    /**< [bytes] - Reduced for ESP32 DRAM constraints */
 ...
 */
#define LV_DRAW_THREAD_STACK_SIZE    (2 * 1024)         /**< [bytes] - Reduced for ESP32 DRAM constraints */
