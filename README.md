...
- **ESP32-4032S040R** - 4.0" 320x480 display with resistive touch
...
1. **Download firmware** from the [Releases](https://github.com/julesdg6/aCYD-MIDI/releases) page
   - Choose the appropriate `.bin` file for your board:
     ...
     **ESP32-4032S040R (4.0" Resistive Touch):**
     - `firmware-esp32-4032S040R` - Default (UART2 for development with debug)
     - `firmware-esp32-4032S040R-uart0` - Production (UART0 for hardware MIDI, no debug)
     - `firmware-esp32-4032S040R-uart2` - Explicit UART2 configuration
...
3. Build and upload for your board:
   ...
   # For ESP32-4032S040R (4.0" Resistive Touch)
   pio run -e esp32-4032S040R -t upload
