...
- **RAGA** - Indian raga explorer with 2nd-order Markov chain music generation for Raga Bhairavi (captures authentic phrases and oscillations), scale selection, drone toggles, and tempo-aware dronescapes ([docs/RAGA_MODE_MARKOV_CHAIN.md](docs/RAGA_MODE_MARKOV_CHAIN.md))
