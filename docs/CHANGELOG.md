...
This is the first pre-release of aCYD-MIDI, providing a complete Bluetooth MIDI controller with 16 interactive modes, hardware MIDI output, remote display capabilities, and comprehensive documentation.
